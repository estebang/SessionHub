...
public class ConferenceDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Session>().HasData(
            ...
            new Session { Id = 16, Title = "Shipping Faster with Better Feedback Loops", Summary = "Use smaller release rhythms and clearer signals to improve delivery quality.", Description = "This practical session shows how rapid feedback loops help cross-functional teams ship confidently, reduce rework, and keep stakeholders aligned.", Track = "Product", Level = SessionLevel.Beginner, Room = "Lakeside 3", StartTimeUtc = new DateTimeOffset(2026, 9, 15, 9, 0, 0, TimeSpan.Zero), EndTimeUtc = new DateTimeOffset(2026, 9, 15, 10, 0, 0, TimeSpan.Zero), SpeakerId = 5 },
            new Session { Id = 17, Title = "Patterns for Agentic Workflows", Summary = "Design AI-assisted experiences that feel helpful, safe, and predictable.", Description = "Learn the patterns that make AI-enabled workflows useful in real product teams, including guardrails, observability, and user trust.", Track = "AI", Level = SessionLevel.Advanced, Room = "Atlas Hall", StartTimeUtc = new DateTimeOffset(2026, 9, 15, 10, 30, 0, TimeSpan.Zero), EndTimeUtc = new DateTimeOffset(2026, 9, 15, 11, 30, 0, TimeSpan.Zero), SpeakerId = 6 },
            new Session { Id = 18, Title = "From Prototype to Production: Lessons Learned", Summary = "Turn a promising prototype into something a team can rely on long term.", Description = "This session distills the common hard-won lessons from taking a small application from an early demo into a real operational system.", Track = "Architecture", Level = SessionLevel.Intermediate, Room = "Grand Ballroom", StartTimeUtc = new DateTimeOffset(2026, 9, 15, 11, 45, 0, TimeSpan.Zero), EndTimeUtc = new DateTimeOffset(2026, 9, 15, 12, 45, 0, TimeSpan.Zero), SpeakerId = 1 },
            new Session { Id = 19, Title = "Practical CSS for Better Product Experiences", Summary = "Use simple styling techniques to improve clarity and visual confidence.", Description = "This session explores how disciplined styling choices can improve readability, responsiveness, and overall product polish without overbuilding the CSS layer.", Track = "Frontend", Level = SessionLevel.Beginner, Room = "Innovation Lab", StartTimeUtc = new DateTimeOffset(2026, 9, 15, 13, 15, 0, TimeSpan.Zero), EndTimeUtc = new DateTimeOffset(2026, 9, 15, 14, 15, 0, TimeSpan.Zero), SpeakerId = 8 },
            new Session { Id = 20, Title = "Operational Excellence for Small Teams", Summary = "Build a sustainable rhythm around deployment, ownership, and reliability.", Description = "Discover the practical habits that help small teams keep a system healthy as it grows without adding unnecessary ceremony.", Track = "Platform", Level = SessionLevel.Intermediate, Room = "Harbor 1", StartTimeUtc = new DateTimeOffset(2026, 9, 15, 14, 45, 0, TimeSpan.Zero), EndTimeUtc = new DateTimeOffset(2026, 9, 15, 15, 45, 0, TimeSpan.Zero), SpeakerId = 7 });
    }
}
